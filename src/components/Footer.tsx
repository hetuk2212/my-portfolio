      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h2 className="text-xl font-bold text-blue-400 mb-4">Hetuk Patel</h2>
            <p className="text-gray-300 mb-4 max-w-md">
              A professional web and mobile application developer focused on creating beautiful, 
              functional, and user-friendly applications.
            </p>
            <p className="text-gray-400 text-sm">
              © {currentYear} Hetuk Patel. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-2">
              ...
              <p>
                <a href="mailto:hetuk2212@gmail.com" className="hover:text-blue-400 transition-colors">
                  hetuk2212@gmail.com
                </a>
              </p>
              <p>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm flex items-center mb-4 sm:mb-0">
            Made with <Heart size={14} className="mx-1 text-red-500" /> by Hetuk Patel
          </p>
